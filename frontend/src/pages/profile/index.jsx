...
const updateProfilePicture = async (file) => {
    ...
    const response = await clientServer.post("/update_profile_picture", formDaa, {
        headers: {
...

{
                    ...
                    className={styles.commentsContainer}>
                        ...
                        className={styles.allCommentsContainer}>
                                ...
                                <input onChange={ handleWorkInputChange} name="years" className={styles.inputField} type="number" placeholder='Years of work' />
                                    <div onClick={() => {
